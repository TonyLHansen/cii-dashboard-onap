...
function addToMustTable(datad, tablename, level, levelcapname, percent) {
	...
	trdataHeaders += "<th><span title='" + badgeDescriptions[level][ciiName] + "'>" + 
	    ciiName.replace(/_/g," ").
	          replace(/(\W+|^)(.)/ig,
		  function(match, chr) { return match.toUpperCase(); }) + 
	    "</span>" +
	    "<span class='" + level + "_detail_span'><br/><br/>" + badgeDescriptions[level][ciiName] +
	    "</span>" +
	    "</th>";
    }
	...
	trdataHeaders += "<th class='optional'><span class='optional' title='" + badgeDescriptions[level][ciiName] + "'>" + 
	    ciiName.replace(/_/g," ").
	          replace(/(\W+|^)(.)/ig,
		  function(match, chr) { return match.toUpperCase(); }) + 
	    "</span>" +
	    "<span class='optional " + level + "_detail_span'><br/><br/>" + badgeDescriptions[level][ciiName] +
	    "</span>" +
	    "</th>";
    }
